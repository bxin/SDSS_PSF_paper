...
%Bo: when we change 600 to 300, we get FIGURES/hist_300.png 
% the shorter runs tend to give smaller timescale. 
% Looking at Fig.5, this is because the shorter runs have very few
% point toward the lower frequency end, therefore are unable to
...
% see output/correlate_temporal/run4874_fwhm_sf_r.png
