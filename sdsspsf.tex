...
The temporal behavior is found to be consistent with both the damped random
walk model with a characteristic timescale of $\sim15-25$ minutes and
a power law with index roughly between $-1.5$ and $-1.0$.
\end{abstract}
