...
at half maximum). The FWHM variation with wavelength folows the
...
ZI write a brief overview of SDSS and motivation for analysis 
...
Why S82, what we used, data size...


\subsection{The treatment of seeing in SDSS}

Steal the relevant text from the EDR and photo papers


\subsubsection{QA plots from SDSS Postage Stamp Pipeline (PSP)}

For each run, camera column and filter, PSP makes three QA plots, 
...
a single parameter, FWHM, we study three aspects of its variation
...
Cross-correlation of FWHM for 6 camera columns and the measurement of structure function
...
SDSS PSF is described in \cite{Lupton2001} and \cite{Lupton2002}. 
