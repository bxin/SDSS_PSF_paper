...
seeing can be predicted from first principles (\cite{Racine2009}). The
...
provided a large database of seeing measurements. The SDSS delivered homogeneous and deep 
